...
// import { Code, Heart, LinkIcon, Mail, Rocket } from "lucide-react";
// import { FaGithub } from "react-icons/fa";

// const AboutPage = () => {
//   const lang = 'en'; // Define lang variable

//   return (
//     <div className="min-h-screen bg-slate-50 dark:bg-[#050505bb] transition-colors duration-500">

//       {/* Hero Image Section */}
//       <div className="relative mt-12 w-full max-w-5xl mx-auto h-[300px] md:h-[500px] rounded-[40px] overflow-hidden shadow-2xl border border-white/20 group">
//         {/* Image Component */}
//         <Image
//           src="https://images.unsplash.com/photo-1628352081506-83c43123ed6d?q=80&w=2000&auto=format&fit=crop" // একটি আধুনিক স্মার্ট ফার্মিংয়ের ছবি
...
//         <div className="absolute bottom-8 left-8 backdrop-blur-md bg-white/10 border border-white/20 p-4 rounded-2xl flex items-center gap-3">
//           <div className="w-3 h-3 bg-green-500 rounded-full animate-ping"></div>
//           <p className="text-white text-sm font-medium">
//             {lang === "en" ? "AI Monitoring Active" : "এআই মনিটরিং সক্রিয়"}
//           </p>
//         </div>
//       </div>
...
//         <div className="p-10 rounded-[40px] bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 shadow-2xl">
//           <h2 className="text-3xl font-bold text-green-600 mb-6 flex items-center gap-3">
//             <Rocket className="w-8 h-8" /> Our Mission
//           </h2>
//           <p className="text-slate-600 dark:text-slate-300 text-lg leading-relaxed">
//             KrishOky-er uddessho holo protiti krishoker kachhe sorbo-shreshṭho
//             agri-products (seeds, fertilizers, tools) pouchhe deya. Google
//             Gemini AI bebohar kore amra bilingual (Bangla-English) support
//             nichhichhi jate bhashar kono badha na thake.
//           </p>
//         </div>
//         <div className="p-10 rounded-[40px] bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 shadow-2xl">
//           <h2 className="text-3xl font-bold text-emerald-500 mb-6 flex items-center gap-3">
//             <Heart className="w-8 h-8" /> Our Vision
//           </h2>
//           <p className="text-slate-600 dark:text-slate-300 text-lg leading-relaxed">
//             Amra emon ekṭi ecosystem toiri korchhi jekhane krishok ebong
//             seller-ra sorasori connect hote parbe. AI review summary ebong
//             automated content generation-er madhyome amra e-commerce-ke aro
//             smart korchhi.
//           </p>
//         </div>
//       </section>
...
//         <div className="relative p-1 bg-gradient-to-br from-green-500 to-blue-500 rounded-[50px]">
//           <div className="bg-white dark:bg-[#0a0a0a] rounded-[48px] p-12 text-center md:text-left flex flex-col md:flex-row items-center gap-12">
//             {/* Profile Image (Roky) */}
//             <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-8 border-slate-100 dark:border-white/5 shadow-2xl">
//               <Image
//                 src="https://res.cloudinary.com/dbua4ih4l/image/upload/v1778513101/Roky18_ts_bg-gray_b3vxye.png" // Ekhane apnar chobi diben
//                 alt="Roky"
//                 fill
...
//               <span className="px-4 py-1 rounded-full bg-green-500/10 text-green-600 text-sm font-bold tracking-widest uppercase">
//                 Meet the Developer
//               </span>
//               <h2 className="text-4xl font-bold text-slate-800 dark:text-white mt-4 mb-2">
//                 Roky (ROKY18)
//               </h2>
//               <h3 className="text-xl text-emerald-500 font-medium mb-6">
//                 Senior Full-stack & MERN Developer
//               </h3>

//               <p className="text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
//                 As-salamu Alaykum! Ami Roky, KrishOky prokolper prodhan
//                 developer. Ami MERN stack ebong Next.js niye kaj korchhi. Amar
//                 lokkhyo holo digital Bangladesh-er krishi khat-ke modern
//                 technology-r sathe porichoy koriye deya.
//               </p>
...
//                   className="p-4 rounded-2xl bg-slate-100 dark:bg-white/5 hover:bg-black hover:text-white transition-all duration-300"
//                 >
...
//                   target="_blank"
//                   rel="noopener noreferrer"
//                   className="p-4 rounded-2xl bg-slate-100 dark:bg-white/5 hover:bg-blue-600 hover:text-white transition-all duration-300"
//                 >
//                   <LinkIcon className="w-6 h-6" />
//                 </a>
//                 <a
//                   href="mailto:roky18bd@gmail.com"
//                   className="p-4 rounded-2xl bg-slate-100 dark:bg-white/5 hover:bg-red-500 hover:text-white transition-all duration-300"
//                 >
...
//                   target="_blank"
//                   rel="noopener noreferrer"
//                   className="flex items-center gap-2 px-6 py-4 rounded-2xl bg-green-600 text-white font-bold hover:shadow-[0_0_20px_rgba(34,197,94,0.4)] transition-all"
//                 >
//                   <Code className="w-5 h-5" /> View Portfolio
//                 </a>
//               </div>
//             </div>
//           </div>
...
//       <footer className="pb-20 text-center opacity-50">
    ...
    <div className="min-h-screen bg-white dark:bg-[#050505] transition-colors duration-500 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 -mt-24 relative z-20">
        <div className="p-10 rounded-[40px] bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 shadow-2xl backdrop-blur-xl group hover:border-green-500/50 transition-all duration-500">
          <h2 className="text-3xl font-bold text-green-600 mb-6 flex items-center gap-3">
            <Rocket className="w-8 h-8 group-hover:animate-bounce" /> {t("আমাদের লক্ষ্য", "Our Mission")}
          </h2>
          <p className="text-slate-600 dark:text-slate-300 text-lg leading-relaxed">
            {t(
        ...
        <div className="p-10 rounded-[40px] bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 shadow-2xl backdrop-blur-xl group hover:border-emerald-500/50 transition-all duration-500">
          <h2 className="text-3xl font-bold text-emerald-500 mb-6 flex items-center gap-3">
            <Heart className="w-8 h-8 group-hover:scale-125 transition-transform" /> {t("আমাদের ভিশন", "Our Vision")}
          </h2>
          <p className="text-slate-600 dark:text-slate-300 text-lg leading-relaxed">
            {t(
          ...
          <div className="bg-white dark:bg-[#0a0a0a] rounded-[58px] p-10 md:p-16 flex flex-col md:flex-row items-center gap-14">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <h3 className="text-xl md:text-2xl text-emerald-500 font-bold mb-8">
                {t("সিনিয়র ফুল-স্ট্যাক ও এমইআরএন ডেভেলপার", "Senior Full-stack & MERN Developer")}
              </h3>
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                ...
                >
                  <Code className="w-6 h-6" /> {t("পোর্টফোলিও", "Portfolio")} <ArrowRight className="w-5 h-5" />
                </a>
              </div>
            </div>
          </div>
      ...
      <footer className="text-center opacity-30 mt-10">
        <p className="font-mono text-xs uppercase tracking-[0.5em]">Crafted with Precision by Roky</p>
      </footer>
    </div>
  );
};
